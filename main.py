...
from catalog import (ROOT, Query, canonical_json, clean, event_date, load_catalog,
                     normalized, parse_budget, parse_hours)
from recommender import Recommender, money
...
def arguments() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--catalog', type=Path, default=ROOT / 'data/catalog.csv', help='CSV или JSONL')
